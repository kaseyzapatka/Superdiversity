 ...
 * File: 2021.01.28 Tree Diagram Data Preparation.do
		...
		* ---------------------------------------
		save "$savedir/Legal Permanent Residents/LPR1998_2019.dta", replace 
				...
				preserve
					...
					export excel using "$tabledir/PRNY2019.xlsx", sheet("legal-perm-res", modify) firstrow(variables)  missing(".")
		...
		* ---------------------------------------
		save "$savedir/Non-immigrants/nonimmigrants1998_2019.dta", replace 
				...
				preserve
					...
					export excel using "$tabledir/TRNY2019.xlsx", sheet("non-immigrant", modify) firstrow(variables)  missing(".")
