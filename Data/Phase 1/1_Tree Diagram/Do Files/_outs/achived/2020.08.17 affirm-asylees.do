 ...
 * File: 2020.08.17 Affirm-Asylees.do
...
save "$tabledir/affirm-asylees1996-2018.dta", replace 

export excel using "$tabledir/2020.08.17 affirm-asylees1996-2018.xlsx", sheet("data", modify) firstrow(variables)  missing(".")
