 ...
 * File: 2020.08.23 affirm-asylees.do
 * Author: Kasey Zapatka 
 * Purpose: Download, clean, and prepare data for affirm-asylee for Tree Diagram for Phase 1 of Superdiveristy Project
 * Data: 
...
* ===================================
import excel "$rawdir/Refugees and Asylees/Affirm-Asylees/fy2009-2018_table17d.xlsx", clear
	...
	* ----------------------------------------------------------
	drop in 1/15
		...
		* rename each row 
		rename A country
		rename B affirm_asylees2009
		rename C affirm_asylees2010
		rename D affirm_asylees2011
		rename E affirm_asylees2012
		rename F affirm_asylees2013
		rename G affirm_asylees2014
		rename H affirm_asylees2015
		rename I affirm_asylees2016
		rename J affirm_asylees2017
		rename K affirm_asylees2018
	...
	* save file 
	save "$savedir/Refugees and Asylees/affirm-asylees2009-2018.dta", replace

	clear all 

* Load data: 1999-2008: Refugees 
* ===================================
import excel "$rawdir/Refugees and Asylees/Affirm-Asylees/fy1999-2008_table17d.xlsx", clear
	...
	* ----------------------------------------------------------
	drop in 1/15
		...
		* rename each row 
		rename A country
		rename B affirm_asylees1999
		rename C affirm_asylees2000
		rename D affirm_asylees2001
		rename E affirm_asylees2002
		rename F affirm_asylees2003
		rename G affirm_asylees2004
		rename H affirm_asylees2005
		rename I affirm_asylees2006
		rename J affirm_asylees2007
		rename K affirm_asylees2008
	...
	* save file 
	save "$savedir/Refugees and Asylees/affirm-asylees1999-2008.dta", replace
...
* ===================================
import excel "$rawdir/Refugees and Asylees/Affirm-Asylees/fy1996-2005_table17d.xls", clear
	...
	* ----------------------------------------------------------
	drop in 1/15
		...
		* rename each row 
		rename A country
		rename B affirm_asylees1996
		rename C affirm_asylees1997
		rename D affirm_asylees1998
	...
	* save file 
	save "$savedir/Refugees and Asylees/affirm-asylees1996-1998.dta", replace
...
use "affirm-asylees2009-2018.dta", clear

			
	* merge all years together
	merge 1:1 country using "affirm-asylees1999-2008.dta"
		drop _merge
	merge 1:1 country using "affirm-asylees1996-1998.dta"
		drop _merge
	
	
		* reshape data to long
		* -------------------
		reshape long affirm_asylees, i(country) j(year)
...
save "$savedir/Refugees and Asylees/Combined/affirm-asylees1998-2018.dta", replace 
