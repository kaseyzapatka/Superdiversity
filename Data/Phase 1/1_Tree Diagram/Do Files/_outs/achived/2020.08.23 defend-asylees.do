 ...
 * File: 2020.08.23 defend-asylees.do
 * Author: Kasey Zapatka 
 * Purpose: Download, clean, and prepare data for defend-asylees for Tree Diagram for Phase 1 of Superdiveristy Project
 * Data: 
...
* ===================================
import excel "$rawdir/Refugees and Asylees/Defend-Asylees/fy2009-2018_table19d.xlsx", clear
	...
	* ----------------------------------------------------------
	drop in 1/15
		...
		* rename each row 
		rename A country
		rename B defend_asylees2009
		rename C defend_asylees2010
		rename D defend_asylees2011
		rename E defend_asylees2012
		rename F defend_asylees2013
		rename G defend_asylees2014
		rename H defend_asylees2015
		rename I defend_asylees2016
		rename J defend_asylees2017
		rename K defend_asylees2018
	...
	* drop the last rows that are notes
	drop in 95/100
		...
		* ------------
		...
		replace country = "Unknown" if country == "Unknown 2"
		
		replace country = "Bosnia-Herzegovina" if country == "Bosnia and Herzegovina"
		
	* save file 
	save "$savedir/Refugees and Asylees/defend-asylees2009-2018.dta", replace

	clear all 

* Load data: 1999-2008: Refugees 
* ===================================
import excel "$rawdir/Refugees and Asylees/Defend-Asylees/fy2000-2009_table19d.xls", clear
	...
	* ----------------------------------------------------------
	drop in 1/15
		...
		* rename each row 
		rename A country
		rename B defend_asylees2000
		rename C defend_asylees2001
		rename D defend_asylees2002
		rename E defend_asylees2003
		rename F defend_asylees2004
		rename G defend_asylees2005
		rename H defend_asylees2006
		rename I defend_asylees2007
		rename J defend_asylees2008
	...
	* save file 
	save "$savedir/Refugees and Asylees/defend-asylees2000-2008.dta", replace
...
* ===================================
import excel "$rawdir/Refugees and Asylees/Defend-Asylees/fy1996-2005_table19d.xls", clear
	...
	* ----------------------------------------------------------
	drop in 1/15
		...
		* rename each row 
		rename A country
		rename B defend_asylees1996
		rename C defend_asylees1997
		rename D defend_asylees1998
		rename E defend_asylees1999
		
	drop F-K // drop 2000 and higher bc got them in last dataset
	...
	* drop the last rows that are notes
	drop in 102/105
		...
		* ------------
		...
		replace country = "Burma" if country == "Burma "
		
		replace country = "Serbia and Montenegro (former)" if country == "Serbia and Montenegro"
		
	* save file 
	save "$savedir/Refugees and Asylees/defend-asylees1996-1999.dta", replace
...
use "defend-asylees2009-2018.dta", clear

			
	* merge all years together
	merge 1:1 country using "defend-asylees2000-2008.dta"
		drop _merge
	merge 1:1 country using "defend-asylees1996-1999.dta"
		drop _merge
	
	
		* reshape data to long
		* -------------------
		reshape long defend_asylees, i(country) j(year)
...
* =====================================
save "$savedir/Refugees and Asylees/Combined/defend-asylees1998-2018.dta", replace 
	...
	1. There will be some discrepencies in total counts for each country by year because of data supression. Values do not
