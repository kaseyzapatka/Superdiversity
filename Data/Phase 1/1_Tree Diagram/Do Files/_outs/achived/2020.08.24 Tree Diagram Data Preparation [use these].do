 ...
 * File: 2020.08.24 Tree Diagram Data Preparation.do
...
global dofiledir "${db}/Phase 1/1_Tree Diagram/Do Files"
	...
	* ===================================
	do "$dofiledir/legal permanent residents.do"
		...
		* ---------------------------------------
		...
		export excel using "$tabledir/2020.08.24 Tree Diagram 1998-2018.xlsx", sheet("legal-perm-res", modify) firstrow(variables)  missing(".")
	...
	* ===================================
	...
	do "$dofiledir/defend-asylees.do"
		...
		* Export to final excel
		* ---------------------------------------
		export excel using "$tabledir/2020.08.24 Tree Diagram 1998-2018.xlsx", sheet("refugees-asylees", modify) firstrow(variables)  missing(".")
	...
	* ===================================
	do "$dofiledir/naturalizations.do"
		...
		* Export to final excel
		* ---------------------------------------
		export excel using "$tabledir/2020.08.24 Tree Diagram 1998-2018.xlsx", sheet("naturalizations", modify) firstrow(variables)  missing(".")
	...
	* ===================================
	do "$dofiledir/non-immigrants.do"
		...
		* Export to final excel
		* ---------------------------------------
		export excel using "$tabledir/2020.08.24 Tree Diagram 1998-2018.xlsx", sheet("non-immigrants", modify) firstrow(variables)  missing(".")
