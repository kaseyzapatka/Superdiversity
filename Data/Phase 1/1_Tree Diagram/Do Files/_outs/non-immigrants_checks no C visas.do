...
import excel "$rawdir/Non-immigrants/checks/fy2018_nonimmsuptable1d.xlsx", clear
	...
	* ------------------------------------------------------
		...
		* collapse F-1 to F-3, J-1, J-2, and M-1 to M-3 admissions into "students" 
		gen students = F1 + F2 + J1 + J2 + M1 + M2 
		...
		* collpase C1, C2, C3, K1, K2, K3, K4, V1, V2, and V3 into "otherclasses"
		gen otherclasses = K1 + K2 + K3 + K4 + V1 + V2 + V3 + Other
	...
	* save file
	save "$savedir/Non-immigrants/checks/nonimmigrants2018-noC.dta", replace
...
import excel "$rawdir/Non-immigrants/checks/2014_nonimmsuptable1d.xls", clear
	...
	* save file
	save "$savedir/Non-immigrants/checks/nonimmigrants2014-noC.dta", replace
...
use "nonimmigrants2018.dta", clear
	...
	* merge dsupplement years for accuracy test
	...
	merge 1:1 country using "nonimmigrants2018-noC.dta"	
		drop _merge 
		
	merge 1:1 country using "nonimmigrants2014-noC.dta"	
		drop _merge
		...
		* ------------------------------------------
		log using "$savedir/Non-immigrants/checks/nonimmigrants2018-check-noC.log", replace
		...
		* ------------------------------------------
		log using "$savedir/Non-immigrants/checks/nonimmigrants2014-check-noC.log", replace
	...
	* save data for further analysis
	save "$savedir/Non-immigrants/checks/nonimmigrants2018_2014-checks-noC.dta", replace
