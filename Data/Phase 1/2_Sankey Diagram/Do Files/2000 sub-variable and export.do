 ...
 * Purpose: code sub-region and region for ancestry and sub-family and family for language for 2000
...
* ====================================		
	...
	* ----------------------------------
	foreach v of varlist language-language_fam {
		...
		* population checks : sum in excel : 2000 and 2010 checks.xlsx : 18,188,354
		fre ancestry_tot
...
* ====================================	
	...
	* -----------------------------------
	...
	export excel using "$tabledir/NY Sankey Diagram.xlsx", sheet("2000", modify) firstrow(variables) keepcellfmt cell(A1)
