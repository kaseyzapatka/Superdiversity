 ...
 * File: 2020.10.09 Sankey Diagram Data Preparation.do
 * Author: Kasey Zapatka 
 * Purpose: code sub-region and region for ancestry and sub-family and family for language for 2018
...
* ====================================		
	...
	* ----------------------------------
	foreach v of varlist language-language_fam {
		...
		* population checks : sum in excel : 2000 and 2010 checks.xlsx : 19,333,311
		fre ancestry_tot
...
* ====================================	
	...
	* -----------------------------------
	local varorder = "ancestry ancestry_subreg ancestry_reg language language_subfam language_fam count ancestry_tot ancestry_subreg_tot ancestry_reg_tot language_tot language_subfam_tot language_fam_tot"
	...
	* -----------------------------------
	...
	export excel using "$tabledir/NY Sankey Diagram.xlsx", sheet("2018", modify) firstrow(variables) keepcellfmt cell(A1)
