...
* ====================================		
	...
	* ----------------------------------
	foreach v of varlist ancestry-language_fam {
		...
		* population checks : all numbers check out : 18,188,354
...
* ====================================	
	...
	* -----------------------------------
	...
	export excel using "$tabledir/2020.08.19 Sankey Diagram.xlsx", sheet("2000", modify) firstrow(variables) keepcellfmt cell(A1)
