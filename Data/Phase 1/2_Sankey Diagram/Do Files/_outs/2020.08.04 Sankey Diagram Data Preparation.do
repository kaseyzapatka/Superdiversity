 ...
 * File: 2020.07.22 Sankey Diagram Data Preparation.do
...
use "$rawdir/usa_00036.dta", clear
  ...
  * do we want to include households in institutional settings?  - wwe plan to include them 
	fre gq
	...
	* recode original language variable 
	...
	replace language = . if language == 96 /* replace "Other/Not Reported"  as missing -- not sure why these are missing*/
		...
		* create sub-family variable 
		...
		lab val language_subfam 1 "Germanic" 2 "Italic" 3 "Celtic" 4 "Hellenic" 5 "Albanian" 6 "Balto-Slavic" 7 "Armenian" ///
		...
		* create family variable 
		...
		recode language_fam (1/32 = 1) /// /* Indo-European */ 
							(34 = 2) /// /* Uralic */ 
							(40 = 3) /// /* Dravidian */ 
							(43/47 = 4) /// /* Sino-Tibetan */ 
							(48 = 5) /// /* Japonic */ 
							(49 = 6) /// /* Koreanic */ 
							(50/51 = 7) /// /* Austro-Asiatic */ 
							(52/56 = 8) /// /* Austronesian */ 
							(57/62 = 9) /// /* Afroasiatic */ 
							(63/64 = 10) /// /* Nilo-Saharan */ 
							(71 = 11) /// /* Eskimo-Aleut */ 
							(72 = 12) /// /* Algic */ 
							(74 = 13) /// /* Other Native American */ 
							(94 = 13) /// /* Other Native American */ 
							(75 = 14) /// /* Eyak-Athabaskan */ 
							(81 = 15) /// /* Siouan-Catawaban */ 
							(82 = 16) /// /* Muskogean */ 
							(83 = 17) /// /* Keresan */ 
							(84 = 18) /// /* Iroquoian */ 
							(89 = 19) /// /* Uto-Aztecan */ 
							(96 = 20) /* Other Native American */ 
							
		lab def language_fam 1 "Indo-European " 2 "Uralic" 3 "Dravidian" 4 "Sino-Tibetan" 5 "Japonic"  6 "Koreanic" 7 "Austro-Asiatic" ///
							 8 "Austronesian" 9 "Afroasiatic" 10 "Nilo-Saharan" 11 "Eskimo-Aleut" 12 "Algic" 13 "Other Native American" ///
							 14 "Eyak-Athabaskan" 15 "Siouan-Catawaban" 16 "Muskogean" 17 "Keresan" 18 "Iroquoian" 19 "Uto-Aztecan" ///
							 20 "Other Native American"
...
contract language ancestr1 [fw = perwt], zero percent(percentage)
	...
	* test of destable command - can i figure out how to work this into my script?
