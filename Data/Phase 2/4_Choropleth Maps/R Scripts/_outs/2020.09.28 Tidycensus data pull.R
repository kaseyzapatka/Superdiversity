...
# work with Census API to call data: 2004-2018 5-year Estimates
# =============================================================
...
ACS.2018 <- get_acs(state = c("NY", "NJ"), geography = "tract", year = 2018,  # specify state, geography, and year
                    variables = c(pop = "B01003_001",
                                  ...
                                  cuban = "B03001_006", dominican = "B03001_007", guatemalan = "B03001_010", 
                                  salvadoran = "B03001_014", 
                                  
                                  nhasiantot = "B02015_001", chinese = "B02015_007", indian ="B02015_002", 
                                  filipino = "	B02015_008", vietnamese = "B02015_022", korean = "B02015_012",
                                  
                                  multiancestry = "B04007_004", 
