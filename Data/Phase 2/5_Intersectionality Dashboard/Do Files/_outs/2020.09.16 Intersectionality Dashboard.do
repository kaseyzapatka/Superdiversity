 ...
 * File: 2020.09.16 Sankey Diagram Data Preparation.do
...
fre age 
	...
	******
	...
	save "$savedir/2020.09.16 Intersectionality Dashboard Data.dta", replace
...
* ============================================================
	...
	*************************
	do "$dodir/hispanic groups.do"
	

	*************************
	* asian (asiangrps1)
	*************************
	do "$dodir/asian groups.do"
