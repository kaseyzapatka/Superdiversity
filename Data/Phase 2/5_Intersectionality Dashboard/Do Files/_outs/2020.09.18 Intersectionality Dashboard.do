 ...
 * File: 2020.09.18 Intersectionality Dashboard.do
...
fre age 
	...
	******
	...
	save "$savedir/2020.09.18 Intersectionality Dashboard Data.dta", replace
...
* ============================================================
use "$savedir/2020.09.18 Intersectionality Dashboard-race-ethnicity.dta", clear

	* append hispanic data
	* ---------------------
	append using "$savedir/2020.09.18 Intersectionality Dashboard-hispanic.dta"
	...
	* append asian data
	* ---------------------
	append using "$savedir/2020.09.18 Intersectionality Dashboard-asian.dta"
		...
		* Calculate z-score = (percent- mean percent) / weighted SD for obs greater than 20
		foreach v of varlist coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden {
			...
			* check that Z-score calculation was for only those were sex was not specified
			br raceth sex coldeg_n coldeg_tot_n pcoldeg z_coldeg if grandtotalflg == 1
			br raceth sex coldeg_n coldeg_tot_n pcoldeg z_coldeg if sex != "Total - Sex"
	...
	* ------------------------------------------
		...
		* Calculate z-score = (percent- mean percent) / weighted SD for obs greater than 20
		foreach v of varlist coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden {
			...
			* check that Z-score calculation was for only those were sex was not specified
			br raceth sex coldeg_n coldeg_tot_n pcoldeg z_coldeg if maletotalflg == 1
			br raceth sex coldeg_n coldeg_tot_n pcoldeg z_coldeg if sex == "male"
	...
	* ------------------------------------------
		...
		* Calculate z-score = (percent- mean percent) / weighted SD for obs greater than 20
		foreach v of varlist coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden {
			...
			* check that Z-score calculation was for only those were sex was not specified
			br raceth sex coldeg_n coldeg_tot_n pcoldeg z_coldeg if femaletotalflg == 1
			br raceth sex coldeg_n coldeg_tot_n pcoldeg z_coldeg if sex == "female"
...
* export to excel 
export excel using "$tabledir/2020.09.18 Intersectionality Dashboard-final.xlsx", sheet("strings", modify) firstrow(variables) keepcellfmt cell(A1)	
