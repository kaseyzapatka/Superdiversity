...
* ============================================================
	...
	* hispanic groups
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data-hispangrps1.dta", clear
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", replace) firstrow(variables) keepcellfmt cell(A1)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A8)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A34)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A185)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 	
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A336)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1237)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1268)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1299)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1480)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1491)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1542)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1843)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A2144)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A3945)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4006)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4067)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4428)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4431)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4442)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4503)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4564)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4925)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4938)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4951)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5024)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5030)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5061)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5092)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5273)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5280)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5317)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify) keepcellfmt cell(A5324)	
			
			
* hispanic groups (hispangrps1) working age data creation and export
* ============================================================
import excel "$tabledir/2020.10.23 Intersectionality Dashboard-hispanic.xlsx", sheet("strings") firstrow clear
...
* save data for merge 
save "$savedir/2020.10.23 Intersectionality Dashboard-hispanic.dta", replace 
