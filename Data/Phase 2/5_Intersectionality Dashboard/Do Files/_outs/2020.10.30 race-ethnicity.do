...
* ============================================================				
	...
	* race-ethnicity
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", replace) firstrow(variables) keepcellfmt cell(A1)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A8)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A34)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A185)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by age_group by NYC by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 	
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A336)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1237)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1268)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1299)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1480)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1491)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by sex by age_group by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   rburden_n = rburden oburden_n = oburden [pw = perwt], by(raceth sex age_group immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1542)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by sex by age_group by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A1843)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by sex by age_group by NYC by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A2144)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by sex by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   rburden_n = rburden oburden_n = oburden [pw = perwt], by(raceth sex immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A3945)
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* collapse dataset: race-ethnicity by sex by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   rburden_n = rburden oburden_n = oburden [pw = perwt], by(raceth sex NYC) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4006)	
	...
	*************************
	use "$savedir/2020.10.23 Intersectionality Dashboard Data.dta", clear
		...
		* ---------------------------------------
		gcollapse (sum) coldeg employed lowincome homeownership speakenghome speakforlanghome rburden oburden (count) pop coldeg_n = coldeg employed_n = employed ///
					   lowincome_n = lowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   rburden_n = rburden oburden_n = oburden [pw = perwt], by(raceth sex NYC immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4067)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4428)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4431)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4442)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4503)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4564)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4925)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4938)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A4951)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5024)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5030)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5061)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5092)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5273)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5280)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify)  keepcellfmt cell(A5317)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings", modify) keepcellfmt cell(A5324)
			

* race-ethnicity (raceth) working age data creation and export
* ============================================================
import excel "$tabledir/2020.10.23 Intersectionality Dashboard-race-ethnicity.xlsx", sheet("strings") firstrow clear
...
* save data for merge 
save "$savedir/2020.10.23 Intersectionality Dashboard-race-ethnicity.dta", replace 
