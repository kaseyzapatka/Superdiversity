 ...
 * File: 2020.11.18 Intersectionality Dashboard.do
...
fre age 
	...
	******
	compress 
		...
		* ----------------------------
		save "$savedir/2020.11.18 Intersectionality Dashboard Data.dta", replace
		...
		* ----------------------------
		use "$savedir/2020.11.18 Intersectionality Dashboard Data.dta", clear 
			...
			* save
			save "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", replace
		...
		* ----------------------------
		use "$savedir/2020.11.18 Intersectionality Dashboard Data.dta", clear 
			...
			* save
			save "$savedir/2020.11.18 Intersectionality Dashboard Data-asiangrps1.dta", replace
...
* ============================================================
use "$savedir/2020.11.18 Intersectionality Dashboard-race-ethnicity.dta", clear

	* append hispanic data
	* ---------------------
	append using "$savedir/2020.11.18 Intersectionality Dashboard-hispanic.dta"
	...
	* append asian data
	* ---------------------
	append using "$savedir/2020.11.18 Intersectionality Dashboard-asian.dta"
...
* export to excel 
export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-final.xlsx", sheet("strings", modify) firstrow(variables) keepcellfmt cell(A1)	
