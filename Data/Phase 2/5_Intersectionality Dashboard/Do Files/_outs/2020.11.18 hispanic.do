...
* ============================================================
	...
	* hispanic groups
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   ...
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1) 
			...
			* formula : z = (x-μ)/σ : z-score == (raw score - population mean) / standard deviation
				...
				foreach v of varlist coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden {
					...
					*check on missing
					br hispangrps1 age_group immig_group employedtpop employedtpop_n z_employedtpop
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", replace) firstrow(variables) keepcellfmt cell(A1)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by age_group 
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 age_group) 
			...
			* formula : z = (x-μ)/σ : z-score == (raw score - population mean) / standard deviation
				...
				foreach v of varlist coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden {
					...
					*check 
					br hispangrps1 sex employedtpop employedtpop_n z_employedtpop
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A8)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by age_group by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 age_group immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A34)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by age_group by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 age_group NYC) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A185)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by age_group by NYC by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 age_group NYC immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 	
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A336)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1237)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 NYC) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1268)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 NYC immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1299)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1480)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex total
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex age_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1491)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex by age_group by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex age_group immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1542)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex by age_group by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex age_group NYC) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A1843)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex by age_group by NYC by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex age_group NYC immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A2144)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex by immig_group
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A3945)
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* gcollapse dataset: hispanic groups by sex by NYC
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex NYC) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4006)	
	...
	*************************
	use "$savedir/2020.11.18 Intersectionality Dashboard Data-hispangrps1.dta", clear
		...
		* ---------------------------------------
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
					   hhlowincome_n = hhlowincome homeownership_n = homeownership  speakenghome_n = speakenghome  speakforlanghome_n = speakforlanghome ///
					   hhrburden_n = hhrburden hhoburden_n = hhoburden [pw = perwt], by(hispangrps1 sex NYC immig_group) 
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4067)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4428)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4431)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4442)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4503)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4564)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4925)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4938)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A4951)		
		...
		gcollapse (sum) coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden (count) pop coldeg_n = coldeg employedtpop_n = employedtpop ///
			...
			* formula : z = (x-μ)/σ : z-score == (raw score - population mean) / standard deviation
				...
				foreach v of varlist coldeg employedtpop hhlowincome homeownership speakenghome speakforlanghome hhrburden hhoburden {
					...
					*check 
					br hispangrps1 employedtpop employedtpop_n z_employedtpop
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5024)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5030)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5061)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5092)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5273)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				...
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5280)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify)  keepcellfmt cell(A5317)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group hispangrps1 
					...
					* export to excel 		
					export excel using "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings", modify) keepcellfmt cell(A5324)	
			
			
* hispanic groups (hispangrps1) working age data creation and export
* ============================================================
import excel "$tabledir/2020.11.18 Intersectionality Dashboard-hispanic.xlsx", sheet("strings") firstrow clear
...
* save data for merge 
save "$savedir/2020.11.18 Intersectionality Dashboard-hispanic.dta", replace 
