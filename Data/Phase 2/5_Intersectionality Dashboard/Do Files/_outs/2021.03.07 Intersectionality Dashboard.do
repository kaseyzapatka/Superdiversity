 ...
 * File: 2021.03.07 Intersectionality Dashboard.do
...
fre age 
	...
	******
	compress 
		...
		* ----------------------------
		save "$savedir/2021.03.07 Intersectionality Dashboard Data.dta", replace
		
		
		* save hispangrps1 datasets
		* ----------------------------
		use "$savedir/2021.03.07 Intersectionality Dashboard Data.dta", clear 
		
			* keep only data for asiangrps1
			keep if hispangrps1 != .
			
			* save
			save "$savedir/2021.03.07 Intersectionality Dashboard Data-hispangrps1.dta", replace
		...
		* ----------------------------
		use "$savedir/2021.03.07 Intersectionality Dashboard Data.dta", clear 
			...
			* save
			save "$savedir/2021.03.07 Intersectionality Dashboard Data-asiangrps1.dta", replace
		...
		* ----------------------------
		use "$savedir/2021.03.07 Intersectionality Dashboard Data.dta", clear 
			...
			* save
			save "$savedir/2021.03.07 Intersectionality Dashboard Data-blackgrps1.dta", replace
...
* ============================================================
use "$savedir/2021.03.07 Intersectionality Dashboard-race-ethnicity.dta", clear

	* append hispanic data
	* ---------------------
	append using "$savedir/2021.03.07 Intersectionality Dashboard-hispanic.dta"
	...
	* append asian data
	* ---------------------
	append using "$savedir/2021.03.07 Intersectionality Dashboard-asian.dta"
	...
	* ---------------------
	append using "$savedir/2021.03.07 Intersectionality Dashboard-black-immigrants.dta"
...
* export to excel 
export excel using "$tabledir/2021.03.07 Intersectionality Dashboard-final.xlsx", sheet("strings", modify) firstrow(variables) keepcellfmt cell(A1)	
