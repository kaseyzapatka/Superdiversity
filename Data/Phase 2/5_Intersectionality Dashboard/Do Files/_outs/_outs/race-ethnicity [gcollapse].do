			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A34)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A177)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 	
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A328)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1157)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1188)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1219)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1400)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1411)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1462)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A1745)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A2046)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A3679)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A3740)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A3801)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4162)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4165)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4176)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4235)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4296)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4632)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4645)	
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4658)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4731)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4737)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4767)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4798)		
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4968)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A4975)
			...
			order pop, after(immig_group)
				...
				* sort for excel 
				sort sex age_group NYC immig_group raceth 
					...
					* export to excel 		
					export excel using "$tabledir/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings", modify)  keepcellfmt cell(A5012)			
			

* race-ethnicity (raceth) working age data creation and export
* ============================================================
import excel "/Users/Dora/Library/Mobile Documents/com~apple~CloudDocs/Projects/Superdiversity/Data/Phase 2/5_Intersectionality Dashboard/Tables/2020.09.16 Intersectionality Dashboard.xlsx", sheet("strings") firstrow clear
